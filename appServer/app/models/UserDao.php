        ...
        if (mb_strlen($displayName) >= 3 && mb_strlen($displayName) <=15):
            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL)):
                ...
                if ($stmt->rowCount() > 0):
                    ...
                    $insert = 'INSERT INTO users (id, displayName, email, createdAt, password, validate_token, account_auth) VALUES (?,?,?,?,?,?,?)';
                    ...
                    $sendMail->setMessage("Link to validate your account: http://192.168.0.14/steam-project-backend/appServer/app/database/accountValidate.php?token=$validate_token");
